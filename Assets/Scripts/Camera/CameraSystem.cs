...
namespace WizardChess.CameraModule
{
    ...
    public class CameraSystem : MonoBehaviour, ICameraSystem
    {
        ...
        [SerializeField] private Vector3 gameplayPosition = new Vector3(4f, 14f, -5f);
        [SerializeField] private Vector3 gameplayRotation = new Vector3(55f, 0f, 0f);
        ...
        /// Uses the default transitionDuration.
        /// </summary>
        public IEnumerator TransitionToBattleView(Vector3 attackerPos, Vector3 defenderPos)
        {
            return TransitionToBattleView(attackerPos, defenderPos, transitionDuration);
        }

        /// <summary>
        /// Smoothly transitions the camera to a close-up battle view with a custom duration.
        /// King captures use 0.8s; standard captures use the default transitionDuration (0.6s).
        /// </summary>
        public IEnumerator TransitionToBattleView(Vector3 attackerPos, Vector3 defenderPos, float customDuration)
        {
            ...
            while (elapsed < customDuration)
            {
                ...
                float t = Mathf.SmoothStep(0f, 1f, Mathf.Clamp01(elapsed / customDuration));
